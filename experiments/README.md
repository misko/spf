...
| [e_hcp1_cross_arm_coupling](e_hcp1_cross_arm_coupling/experiment_readme.md) | Can the bare-tee harness account for the arm-specific residual `A`, which is the doubt hanging over the whole dual-RX phase programme? | ✅ run 2026-08-11 — **no**: coupling is ≤1.25 dB (median 0.50, n=24) and **frequency-flat** across 12 LOs, while `A` rises ~5× into the high band. Bounds phase coupling at ≲8.9° worst case, ~3° typical. E-GSC6 unblocked; E-GSP2 still the definitive A/B but no longer urgent |
