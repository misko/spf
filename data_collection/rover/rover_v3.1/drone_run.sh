...
if [ ${rover_id} -eq 1 ]; then
    routine=bounce
    config=${repo_root}/data_collection/rover/rover_v3.1/capture_configs/rover_receiver_config_pi_3mhz_35mm.yaml 
    n=3000
	expected_radios=2
elif [ ${rover_id} -eq 2 ]; then
    #config=${repo_root}/spf/rover_configs/rover_emitter_config_pi.yaml 
    config=${repo_root}/data_collection/rover/rover_v3.1/capture_configs/rover_single_receiver_config_pi_3mhz.yaml
    routine=circle
    n=3500
	expected_radios=1
elif [ ${rover_id} -eq 3 ]; then
    routine=bounce
    config=${repo_root}/data_collection/rover/rover_v3.1/capture_configs/rover_receiver_config_pi_3mhz_43mm.yaml 
    n=3000
	expected_radios=2
else
