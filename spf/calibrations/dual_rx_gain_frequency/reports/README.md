...
| [Gain-state phase model and mechanism](gain_state_phase_model_20260802_v1/REPORT.md) | Re-analysis of the A–G campaign for mechanism and minimal parameterisation: model-free symmetry decomposition, audited-hardware-state indexing, LNA-state-modulated reflection ripple, and a 35-rung model ladder under epoch / frequency / frequency-block / radio / gain-table-band holdout, all with a measured equal-gain anchor as an input | Gain effect is 94–99% antisymmetric between arms and steps with the audited mixer word (2.664°/dB vs 0.343° for a baseband-LPF-only step, 7.8×); a 27-parameter **universal** model reaches 2.26° unseen-frequency and 2.22° unseen-radio MAE against a 6.65° no-correction baseline (2.83° and 8.31° on unequal-gain cells); no parameter needs to be radio-specific; does not extrapolate across a gain-table band |
