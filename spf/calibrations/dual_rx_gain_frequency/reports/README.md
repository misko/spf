...
| Report | Scope | Status |
|---|---|---|
| [A–G controlled spectroscopy campaign](spectroscopy_campaign_20260730_v1/README.md) | Radios `.17` and `.18`; 400–5900 MHz baseline, RX1 11 dB pad, RX1 30 cm jumper, restored baseline, crossed TX levels, low-gain coverage, and 12-hour hot repeat | All A–G acquisitions complete; 11 dB pad independently confirmed by −10.49 dB amplitude change; jumper adds 1.36–1.49 ns effective delay; restored-to-hot repeat is 0.90–0.96° MAE overall |
