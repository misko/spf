...
STAGE_ROOTS = {
    ...
    # ---- 2026-08-07 prospective follow-up campaign (E-CAL2 / E-CAL3) --------
    "P_dense": ("gain_state_followups_20260807_v1", "E_CAL3_PROSPECTIVE_DENSE"),
    "P_train_repeat": ("gain_state_followups_20260807_v1", "E_CAL3_TRAIN_REPEAT"),
    "P_rate_pilot": ("gain_state_followups_20260807_v1", "rate_pilot"),
    "P_cal2_low": ("gain_state_followups_20260807_v1", "E_CAL2_LOW"),
    "P_cal2_middle": ("gain_state_followups_20260807_v1", "E_CAL2_MIDDLE"),
    "P_cal2_high": ("gain_state_followups_20260807_v1", "E_CAL2_HIGH"),
}
