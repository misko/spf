...
def load_dataloaders(
    ...
    for ds in val_datasets:
        key = f"{ds.sdr_device_type}:{ds.get_collector_identifier()}:{ds.get_emitter_type()}:{ds.get_wavelength_identifier()}:rf_{ds.rf_bandwidths[0]:0.3e}:{ds.yaml_config['routine']}"
