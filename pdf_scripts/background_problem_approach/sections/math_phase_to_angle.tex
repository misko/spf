...
\begin{enumerate}
  ...
  \item \textbf{It is amplitude-weighted.} Strong samples dominate the sum.
        ...
        the weighting (gain-index polarity flips were mitigated in SPF's rigs
        in Jan~2024 via the AD9361 polarity-invert controls).
...
$\approx 0.9$. Heavy tails from AGC gain steps (and, on rigs predating the
Jan-2024 polarity-bit fixes, LNA-bypass flips) inflate it further. These anchors calibrate every quality gate
in the audit.
